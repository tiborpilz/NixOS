...
let
  ...
  groups = [
    ...
    (mkGroup "Downloads" [
      ...
      { enable = ms.media.music.slskd.enable; name = "slskd"; sub = "slskd"; icon = "slskd"; description = "Soulseek client"; }
      { enable = ms.media.music.soularr.enable; name = "Soularr"; sub = "soularr"; icon = "soularr"; description = "Lidarr → Soulseek bridge"; }
      { enable = ms.media.music.aurral.enable; name = "Aurral"; sub = "aurral"; icon = "lidarr"; description = "Music requests & discovery"; }
    ])
